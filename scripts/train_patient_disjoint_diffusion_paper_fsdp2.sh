...
config_path="${1:-config/patient_disjoint_fsdp2_paper.json}"
...
# Revalidate the frozen patient split, source hashes, repaired RR cache, VAE
# dependency, and clean latent cache before starting the corrected U-Net run.
